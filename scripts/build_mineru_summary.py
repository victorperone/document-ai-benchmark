...
OUTPUT_ROOT = Path("/outputs/mineru")
METRICS_ROOT = Path("/metrics")

CSV_PATH = METRICS_ROOT / "mineru_summary.csv"
MARKDOWN_PATH = METRICS_ROOT / "mineru_summary.md"
        ...
        results.append(
            {
                ...
                "charts": data["content"]["charts_detected"],
...
def write_markdown(
    ...
    lines = [
        "# MinerU CPU Benchmark Summary",
        "",
        "Pipeline backend with method=txt and OCR disabled.",
        "",
